...
if __name__ == '__main__':
    ...
    r = checksum(test_sheet)
    
    assert r == 18, 'Fails test'
    
    p = [[409, 194, 207, 470, 178, 454, 235, 333, 511, 103, 474, 293, 525, 372, 408, 428],
    ...
    print('First checksum:{}'.format(checksum(p)))


    test_sheet_2 = [[5, 9, 2, 8],
                    [9, 4, 7, 3],
                    [3, 8, 6, 5]]

    r2 = checksum_2(test_sheet_2)

    assert r2 == 9, 'Fails second test'

    print('Second checksum:{}'.format(checksum_2(p)))
